...
public class SemanticCheck
{
    ...
    public void CheckExpression(IExpression expression, Scope scope)
    {
        ...
        switch (expression)
        {
            ...
            case Product:
            case Division:
            case Power: CheckBinaryOperator((BinaryOperatorSyntax)expression, ExpressionType.Number, ExpressionType.Number, scope); break;
            case Equal:
            case Different: CheckEqualityOperator((BinaryOperatorSyntax)expression, scope); break;
            case GreaterEqual:
            case LessEqual:
            case Less:
            case Greater: CheckBinaryOperator((BinaryOperatorSyntax)expression, ExpressionType.Number, ExpressionType.Bool, scope); break;
            case And:
            case Or: CheckBinaryOperator((BinaryOperatorSyntax)expression, ExpressionType.Bool, ExpressionType.Bool, scope); break;
            case ConcatSpace:
            case Concat: CheckBinaryOperator((BinaryOperatorSyntax)expression, ExpressionType.String, ExpressionType.String, scope); break;
    ...
    public void CheckBinaryOperator(BinaryOperatorSyntax binaryOp, ExpressionType operandtypes, ExpressionType operatortype, Scope scope)
    {
    ...
    public void CheckEqualityOperator(BinaryOperatorSyntax binaryOp, Scope scope)
    {
    ...
    public void CheckUnary(UnaryOperatorSyntax unary, ExpressionType type, Scope scope)
    {
