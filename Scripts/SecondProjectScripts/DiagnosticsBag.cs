...
public class DiagnosticsBag : IEnumerable<Diagnostics>
{
    ...
    public void AddRange(IEnumerable diagnostics)
    {
        _diagnostics.AddRange(diagnostics.ConvertTo(List<Diagnostics>));
    }

    private void ReportError(TextLocation location, string message)
    {
        var diagnostic = Diagnostics.Error(location, message);
        _diagnostics.Add(diagnostic);
    }

    private void ReportWarning(TextLocation location, string message)
    {
        var diagnostic = Diagnostics.Warning(location, message);
        _diagnostics.Add(diagnostic);
    }
    ...
    public void ReportUnreachableCode(SyntaxNode node)
    {
        switch (node.Type)
        {
            ...
            case TokenType.WhileStatement:
                ...
                return;
            case TokenType.DoWhileStatement:
